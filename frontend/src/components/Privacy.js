...
function PrivacyScreen() {
  return (
    <div className="Container">
      ...
      <p>
        Flicky built the Flicky Online Shopping App app as a Free app. This
        SERVICE is provided by Flicky at no cost and is intended for use as is.
      </p>{' '}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at Flicky Online Shopping App
